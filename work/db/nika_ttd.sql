...
--
-- Хост: 127.0.0.1
-- Време на генериране:  9 авг 2025 в 08:27
...
(27, '2025-08-09 00:51:55.836556', '1', 'ТОДОРКА VERTICAL', 2, '[{\"changed\": {\"fields\": [\"\\u0422\\u0435\\u043a\\u0443\\u0449 \\u0441\\u0442\\u0430\\u0442\\u0443\\u0441 \\u043d\\u0430 \\u0441\\u044a\\u0441\\u0442\\u0435\\u0437\\u0430\\u043d\\u0438\\u0435\\u0442\\u043e\"]}}]', 10, 1);
...
(18, 'Верадина Начева', 14, '-:--:--.-', 4, 999, 1, 'M', 0),
(19, 'Станислав Чолаков', 9, '-:--:--.-', 3, 999, 1, 'M', 1),
(20, 'Емил Димитров', 88, '-:--:--.-', 4, 999, 1, 'M', 1),
(21, 'Влади Веков', 214, '-:--:--.-', 4, 999, 1, 'M', 1),
(22, 'Момчил Фичев', 7, '-:--:--.-', 3, 999, 1, 'M', 1),
(23, 'Виктор Василев', 48, '-:--:--.-', 3, 999, 1, 'M', 1),
(24, 'Кристиян Кобер', 2, '-:--:--.-', 5, 18, 2, 'M', 1),
(25, 'Калинка Мишева', 188, '-:--:--.-', 4, 999, 1, 'M', 0),
(26, 'Сабина  Гълъбова', 158, '-:--:--.-', 3, 999, 1, 'M', 0),
(27, 'Марко Ноков', 3, '-:--:--.-', 1, 999, 1, 'M', 1),
(28, 'Емил Гьорев', 179, '-:--:--.-', 3, 999, 1, 'M', 1),
(29, 'Димитър Дишев', 75, '-:--:--.-', 3, 999, 1, 'M', 1),
(30, 'Йоана Петроу', 187, '-:--:--.-', 3, 999, 1, 'M', 0),
(32, 'Георги Танев', 62, '-:--:--.-', 3, 999, 1, 'M', 1),
(33, 'Момчил Момчилов', 128, '-:--:--.-', 5, 999, 1, 'M', 1),
(34, 'Александър Попов', 27, '-:--:--.-', 3, 999, 1, 'M', 1),
(35, 'Силвия Стефанова', 160, '-:--:--.-', 3, 999, 1, 'M', 0),
(36, 'Андрей Николов', 32, '-:--:--.-', 3, 999, 1, 'M', 1),
(37, 'Димитриус Папаникус', 11, '-:--:--.-', 3, 999, 1, 'M', 1),
(38, 'Памела Узунова', 142, '-:--:--.-', 3, 999, 1, 'M', 0),
(39, 'Божидар Иванчев', 35, '-:--:--.-', 3, 999, 1, 'M', 1),
(40, 'Славчо Гаврилов', 161, '-:--:--.-', 4, 999, 1, 'M', 1),
(41, 'Весела Димитрова', 46, '-:--:--.-', 5, 999, 1, 'M', 0),
(42, 'Анелия Партенова', 33, '4:24:25.3', 3, 0, 3, 'M', 0),
(43, 'Ангел Праматаров', 30, '-:--:--.-', 3, 999, 1, 'M', 1),
(44, 'Петър Тодоров', 204, '-:--:--.-', 4, 999, 1, 'M', 1),
(45, 'Красимир Стефанов', 191, '-:--:--.-', 4, 999, 1, 'M', 1),
(46, 'Борислав Въчков', 177, '-:--:--.-', 3, 999, 1, 'M', 1),
(47, 'Борис Кюшев', 37, '-:--:--.-', 1, 999, 1, 'M', 1),
(48, 'Асен Радулов', 1, '-:--:--.-', 3, 999, 1, 'M', 1),
(49, 'Деян Ангеловски', 69, '-:--:--.-', 3, 999, 1, 'M', 1),
(50, 'Юлиан Иванов', 173, '-:--:--.-', 4, 999, 1, 'M', 1),
(51, 'Нина Чолева', 138, '-:--:--.-', 4, 999, 1, 'M', 0),
(52, 'Лазар Варин', 113, '-:--:--.-', 3, 999, 1, 'M', 1),
(53, 'Валентин Василев', 40, '-:--:--.-', 3, 999, 1, 'M', 1),
(54, 'Александър Грънчаров', 24, '-:--:--.-', 4, 999, 1, 'M', 1),
(55, 'Глория Русева', 64, '-:--:--.-', 3, 999, 1, 'M', 0),
(56, 'Емил Гьорев', 87, '-:--:--.-', 3, 999, 1, 'M', 1),
(57, 'Георги Александров', 57, '-:--:--.-', 4, 999, 1, 'M', 1),
(58, 'Виктор Китин', 49, '-:--:--.-', 3, 999, 1, 'M', 1),
(59, 'Гошо Иванов', 183, '-:--:--.-', 4, 999, 1, 'M', 1),
(60, 'Ирина Горанова', 103, '-:--:--.-', 4, 999, 1, 'M', 0),
(61, 'Александър Димитров', 25, '-:--:--.-', 4, 999, 1, 'M', 1),
(62, 'Иван Каназирев', 96, '-:--:--.-', 3, 999, 1, 'M', 1),
(63, 'Георги Турлаков', 63, '-:--:--.-', 3, 999, 1, 'M', 1),
(64, 'Александър Шопов', 150, '-:--:--.-', 6, 999, 1, 'M', 1),
(65, 'Слави Асенов', 8, '-:--:--.-', 4, 999, 1, 'M', 1),
(66, 'Юлиан Валентинов Иванов', 172, '-:--:--.-', 4, 999, 1, 'M', 1),
(67, 'Иван Иванов', 95, '-:--:--.-', 4, 999, 1, 'M', 1),
(68, 'Асен Асенов', 207, '-:--:--.-', 4, 999, 1, 'M', 1),
(69, 'Павло Левко', 203, '-:--:--.-', 3, 999, 1, 'M', 1),
(70, 'Момчил Блъсков', 127, '-:--:--.-', 3, 999, 1, 'M', 1),
(71, 'Надежда Маркова', 130, '-:--:--.-', 3, 999, 1, 'M', 0),
(72, 'Илиян Петков', 102, '-:--:--.-', 4, 999, 1, 'M', 1),
(73, 'Мартин Сугарев', 124, '-:--:--.-', 3, 999, 1, 'M', 1),
(74, 'Петър Галчев', 145, '-:--:--.-', 4, 999, 1, 'M', 1),
(75, 'Никола Кръстев Ръжев', 134, '-:--:--.-', 1, 999, 1, 'M', 1),
(76, 'Даниела Маринова', 66, '-:--:--.-', 4, 999, 1, 'M', 0),
(77, 'Димирър Търев', 79, '-:--:--.-', 3, 999, 1, 'M', 1),
(78, 'Борислав Чолев', 39, '-:--:--.-', 3, 999, 1, 'M', 1),
(79, 'Росен Стоянов', 157, '-:--:--.-', 3, 999, 1, 'M', 1),
(80, 'Емил Филипов', 90, '-:--:--.-', 4, 999, 1, 'M', 1),
(81, 'Александър Христов', 29, '-:--:--.-', 3, 999, 1, 'M', 1),
(82, 'Кристиян Стоянов', 112, '-:--:--.-', 3, 999, 1, 'M', 1),
(83, 'Илияна Стефанова', 16, '-:--:--.-', 3, 999, 1, 'M', 0),
(84, 'Мартин Малечков', 122, '-:--:--.-', 3, 999, 1, 'M', 1),
(85, 'Ивайло Пейнов', 6, '-:--:--.-', 2, 999, 1, 'M', 1),
(86, 'Ивона Михайлова', 15, '-:--:--.-', 4, 999, 1, 'M', 0),
(87, 'Павлин Беев', 141, '-:--:--.-', 3, 999, 1, 'M', 1),
(88, 'Виктор Стефанов', 4, '-:--:--.-', 4, 999, 1, 'M', 1),
(89, 'Даниела Христова', 67, '-:--:--.-', 5, 999, 1, 'M', 0),
(90, 'Иван Шопов', 100, '-:--:--.-', 3, 999, 1, 'M', 1),
(91, 'Христо Боянов', 185, '-:--:--.-', 3, 999, 1, 'M', 1),
(92, 'Райна Коюва', 208, '-:--:--.-', 4, 999, 1, 'M', 0),
(93, 'Иван Христов', 99, '-:--:--.-', 3, 999, 1, 'M', 1),
(94, 'Емил Хедков', 89, '-:--:--.-', 4, 999, 1, 'M', 1),
(95, 'Марина Анастасова', 17, '-:--:--.-', 2, 999, 1, 'M', 0),
(96, 'Никола Френчев', 199, '-:--:--.-', 1, 999, 1, 'M', 1),
(97, 'Красимир Маринов', 110, '-:--:--.-', 3, 999, 1, 'M', 1),
(98, 'Надежда Крумова', 129, '-:--:--.-', 3, 999, 1, 'M', 0),
(99, 'Леасабрина Кауфман', 21, '-:--:--.-', 3, 999, 1, 'M', 0),
(100, 'Данаил Павлов', 65, '-:--:--.-', 3, 999, 1, 'M', 1),
(101, 'Невелина Павлова', 131, '-:--:--.-', 3, 999, 1, 'M', 0),
(102, 'Петя Бандева', 206, '-:--:--.-', 3, 999, 1, 'M', 0),
(103, 'Стамена Вълчева', 164, '-:--:--.-', 5, 999, 1, 'M', 0),
(104, 'Михаела Димитрова', 19, '-:--:--.-', 3, 999, 1, 'M', 0),
(105, 'Тихомир Христов', 169, '-:--:--.-', 3, 999, 1, 'M', 1),
(106, 'Никол Калчева', 133, '-:--:--.-', 3, 999, 1, 'M', 0),
(107, 'Борислав Димитров', 38, '-:--:--.-', 5, 999, 1, 'M', 1),
(108, 'Мария Николова', 195, '-:--:--.-', 3, 999, 1, 'M', 0),
(109, 'Вилиян Петков', 52, '-:--:--.-', 3, 999, 1, 'M', 1),
(110, 'Цветан Бакърджиев', 10, '-:--:--.-', 4, 999, 1, 'M', 1),
(111, 'Теодора Станкова', 167, '-:--:--.-', 3, 999, 1, 'M', 0),
(112, 'Виктор Стефанов', 50, '-:--:--.-', 2, 999, 1, 'M', 1),
(113, 'Мариана Денева', 118, '-:--:--.-', 5, 999, 1, 'M', 0),
(114, 'Виктория Тенева', 51, '-:--:--.-', 3, 999, 1, 'M', 0),
(115, 'Дойчин Дойчев', 80, '-:--:--.-', 2, 999, 1, 'M', 1),
(116, 'Огняна Бакърджиева', 20, '-:--:--.-', 1, 999, 1, 'M', 0),
(117, 'Лазар Димитров', 193, '-:--:--.-', 3, 999, 1, 'M', 1),
(118, 'Петър Карамитов', 147, '-:--:--.-', 3, 999, 1, 'M', 1),
(119, 'Георги Стоянов', 61, '-:--:--.-', 3, 999, 1, 'M', 1),
(120, 'Николай Колев', 200, '-:--:--.-', 4, 999, 1, 'M', 1),
(121, 'Надя Гелова', 198, '-:--:--.-', 3, 999, 1, 'M', 0),
(122, 'Велислав Стоев', 213, '-:--:--.-', 3, 999, 1, 'M', 1),
(123, 'Жаклина Жекова', 186, '-:--:--.-', 3, 999, 1, 'M', 0),
(124, 'Светлин Игнатов', 211, '-:--:--.-', 3, 999, 1, 'M', 1),
(125, 'Павел Марков', 140, '-:--:--.-', 3, 999, 1, 'M', 1),
(126, 'Лазар Кърчев', 114, '-:--:--.-', 3, 999, 1, 'M', 1),
(127, 'Делина Тенева', 70, '-:--:--.-', 3, 999, 1, 'M', 0),
(128, 'Емо Горянов', 181, '-:--:--.-', 3, 999, 1, 'M', 1),
(129, 'Емилия Драгосинова', 91, '-:--:--.-', 4, 999, 1, 'M', 0),
(130, 'Радослав Дурев', 156, '-:--:--.-', 3, 999, 1, 'M', 1),
(131, 'Мария Михнева', 119, '-:--:--.-', 3, 999, 1, 'M', 0),
(132, 'Мария Хинкова', 18, '-:--:--.-', 1, 999, 1, 'M', 0),
(133, 'Красимир Василев', 107, '-:--:--.-', 3, 999, 1, 'M', 1),
(134, 'Димитър Геогиев', 73, '-:--:--.-', 7, 999, 1, 'M', 1),
(135, 'Елена Кемилева', 83, '-:--:--.-', 3, 999, 1, 'M', 0),
(136, 'Димитър Стоянов', 78, '-:--:--.-', 4, 11, 2, 'M', 1),
(137, 'Янко Месьов', 174, '-:--:--.-', 4, 999, 1, 'M', 1),
(138, 'Славчо Тумбев', 163, '-:--:--.-', 4, 999, 1, 'M', 1),
(139, 'Преслав Христов', 153, '-:--:--.-', 3, 999, 1, 'M', 1),
(140, 'Иван Попов', 98, '-:--:--.-', 4, 999, 1, 'M', 1),
(141, 'Мартин Стоименов', 123, '-:--:--.-', 3, 999, 1, 'M', 1),
(142, 'Дарина Славчева', 68, '-:--:--.-', 4, 999, 1, 'M', 0),
(143, 'Кирил Дамянов', 106, '-:--:--.-', 3, 999, 1, 'M', 1),
(144, 'Григор Григоров', 12, '-:--:--.-', 2, 999, 1, 'M', 1),
(145, 'Калоян Николов', 104, '-:--:--.-', 3, 999, 1, 'M', 1),
(146, 'Мъри Иванов', 197, '-:--:--.-', 3, 999, 1, 'M', 1),
(147, 'Владимир Астарджиев', 55, '-:--:--.-', 3, 999, 1, 'M', 1),
(148, 'Виктор Василев', 47, '-:--:--.-', 3, 999, 1, 'M', 1),
(149, 'Ани Томева', 34, '-:--:--.-', 3, 999, 1, 'M', 0),
(150, 'Дейвид Кларк', 178, '-:--:--.-', 6, 999, 1, 'M', 1),
(151, 'Робин Хамилтън', 209, '-:--:--.-', 6, 999, 1, 'M', 1),
(152, 'Мария Кларк', 194, '-:--:--.-', 3, 999, 1, 'M', 0),
(153, 'Катя Глушкова', 189, '-:--:--.-', 5, 999, 1, 'M', 0),
(154, 'Николай Бенковски', 135, '-:--:--.-', 3, 999, 1, 'M', 1),
(155, 'Александър Димитров', 26, '-:--:--.-', 3, 13, 2, 'M', 1),
(156, 'Лора Божилова', 115, '4:24:07.9', 3, 0, 3, 'M', 0),
(157, 'Камелия Божилова', 105, '-:--:--.-', 4, 12, 2, 'M', 0),
(158, 'Димитър Мавродиев', 76, '4:12:45.6', 5, 0, 3, 'M', 1),
(159, 'Мехмед Мехмед', 126, '-:--:--.-', 4, 15, 2, 'M', 1),
(160, 'Елена Татарска', 84, '1:36:42.8', 5, 0, 3, 'M', 0),
(161, 'Андрий Дерунов', 176, '1:36:45.7', 5, 0, 3, 'M', 1),
(162, 'Красимир Гергов', 109, '1:36:32.1', 4, 0, 3, 'M', 1),
(163, 'Иван Пандинов', 97, '1:36:40.3', 5, 0, 3, 'M', 1),
(164, 'Мартин Инчев', 121, '-:--:--.-', 3, 16, 2, 'M', 1),
(165, 'Паул Чапман', 202, '-:--:--.-', 5, 1, 2, 'M', 1),
(166, 'Трейси Пийт', 212, '-:--:--.-', 5, 999, 1, 'M', 0),
(167, 'Теодора Тодорова', 168, '4:25:19.3', 3, 0, 3, 'M', 0),
(168, 'Мартин Тодоров', 125, '-:--:--.-', 2, 999, 1, 'M', 1),
(169, 'Стоян Мавродиев', 166, '-:--:--.-', 4, 999, 1, 'M', 1),
(170, 'Емилиян Френчев', 180, '-:--:--.-', 4, 999, 1, 'M', 1),
(171, 'Владимир Ангелов', 53, '-:--:--.-', 4, 10, 2, 'M', 1),
(172, 'Владимир Ангелов', 54, '-:--:--.-', 2, 999, 1, 'M', 1),
(173, 'Диан Стайков', 72, '-:--:--.-', 3, 999, 1, 'M', 1),
(174, 'Николай Николов', 136, '-:--:--.-', 3, 999, 1, 'M', 1),
(175, 'Кристина Стоименова', 111, '-:--:--.-', 3, 999, 1, 'M', 0),
(176, 'Аглика Бяндова', 175, '4:24:11.3', 3, 0, 3, 'M', 0),
(177, 'Петър Тодоров', 149, '-:--:--.-', 4, 999, 1, 'M', 1),
(178, 'Георги Котирков', 60, '-:--:--.-', 4, 999, 1, 'M', 1),
(179, 'Величка Котиркова', 42, '1:35:59.7', 4, 0, 3, 'M', 0),
(180, 'Хасан Сакалов', 184, '-:--:--.-', 5, 999, 1, 'M', 1),
(181, 'Николай Христов', 137, '-:--:--.-', 4, 999, 1, 'M', 1),
(182, 'Магдалена Липева', 117, '-:--:--.-', 3, 999, 1, 'M', 0),
(183, 'Деница Минчева', 71, '-:--:--.-', 3, 999, 1, 'M', 0),
(184, 'Ива Николова', 92, '-:--:--.-', 5, 999, 1, 'M', 0),
(185, 'Димитър Димитров', 74, '-:--:--.-', 4, 999, 1, 'M', 1),
(186, 'Пламена Аврамова', 152, '-:--:--.-', 3, 999, 1, 'M', 0),
(187, 'Славчо Тричков', 162, '-:--:--.-', 4, 999, 1, 'M', 1),
(188, 'Здравко Кръстев', 5, '-:--:--.-', 3, 999, 1, 'M', 1),
(189, 'Христо Топузов', 171, '-:--:--.-', 4, 999, 1, 'M', 1),
(190, 'Александър Топузов', 28, '-:--:--.-', 3, 999, 1, 'M', 1),
(191, 'Костадин Ганчев', 190, '-:--:--.-', 4, 999, 1, 'M', 1),
(192, 'Люба Хлебарова', 116, '-:--:--.-', 6, 999, 1, 'M', 0),
(193, 'Гергана Божкова', 182, '-:--:--.-', 3, 999, 1, 'M', 0),
(194, 'Велизар Блъсков', 41, '-:--:--.-', 3, 999, 1, 'M', 1),
(195, 'Елена Ташева', 85, '-:--:--.-', 5, 999, 1, 'M', 0),
(196, 'Димитър Мичков', 77, '-:--:--.-', 3, 999, 1, 'M', 1),
(197, 'Драгомир Драгиев', 81, '-:--:--.-', 4, 999, 1, 'M', 1),
(198, 'Мартин Добрев', 120, '-:--:--.-', 3, 999, 1, 'M', 1),
(199, 'Станислав Крушовалиев', 165, '-:--:--.-', 3, 999, 1, 'M', 1),
(200, 'Петър Рангелов', 148, '-:--:--.-', 4, 999, 1, 'M', 1),
(201, 'Георги Бреснички', 58, '-:--:--.-', 4, 999, 1, 'M', 1),
(202, 'Венелина Захариева', 45, '-:--:--.-', 4, 999, 1, 'M', 0),
(203, 'Петър Бонев', 144, '-:--:--.-', 6, 999, 1, 'M', 1),
(204, 'Александър Бекяров', 23, '-:--:--.-', 4, 999, 1, 'M', 1),
(205, 'Радка Петкова', 154, '-:--:--.-', 4, 999, 1, 'M', 0),
(206, 'Мартин Маринов', 196, '-:--:--.-', 4, 999, 1, 'M', 1),
(207, 'Панталей Златков', 143, '-:--:--.-', 3, 999, 1, 'M', 1),
(208, 'Екатерина Куртева', 82, '-:--:--.-', 3, 999, 1, 'M', 0),
(209, 'Христо Кръстев', 170, '-:--:--.-', 4, 999, 1, 'M', 1),
(210, 'Красимир Георгиев Стоянов', 108, '-:--:--.-', 7, 999, 1, 'M', 1),
(211, 'Радослав Байрактаров', 155, '-:--:--.-', 4, 999, 1, 'M', 1),
(212, 'Ема Байрактарова', 86, '-:--:--.-', 1, 999, 1, 'M', 0),
(213, 'Милица Мирчева', 13, '-:--:--.-', 3, 999, 1, 'M', 0),
(214, 'Петър Джостов', 146, '-:--:--.-', 4, 999, 1, 'M', 1),
(215, 'Никол Йорданова', 132, '-:--:--.-', 1, 999, 1, 'M', 0),
(216, 'Светослав Сугарев', 159, '-:--:--.-', 3, 999, 1, 'M', 1),
(217, 'Савина Николова', 210, '-:--:--.-', 3, 999, 1, 'M', 0),
(218, 'Кристин Генкова', 192, '-:--:--.-', 3, 999, 1, 'M', 0),
(219, 'Илияна Вълканова', 22, '-:--:--.-', 1, 999, 1, 'M', 0),
(220, 'Иван Белянов', 94, '-:--:--.-', 3, 999, 1, 'M', 1),
(221, 'Пламен Лилов', 151, '-:--:--.-', 4, 999, 1, 'M', 1),
(222, 'Иво Христов', 101, '-:--:--.-', 3, 999, 1, 'M', 1),
(223, 'Георги Жегов', 59, '-:--:--.-', 4, 999, 1, 'M', 1),
(224, 'Петър Петров', 205, '-:--:--.-', 5, 999, 1, 'M', 1),
(225, 'Владимир Тумбев', 56, '-:--:--.-', 3, 999, 1, 'M', 1),
(226, 'Николай Димитров', 201, '-:--:--.-', 4, 999, 1, 'M', 1),
(227, 'Велияна Лозанова', 43, '-:--:--.-', 3, 999, 1, 'M', 0),
(228, 'Андрей Къртунов', 31, '-:--:--.-', 4, 999, 1, 'M', 1),
(229, 'Божидар Къртунов', 36, '-:--:--.-', 3, 999, 1, 'M', 1),
(230, 'Ивайло Станимиров', 93, '-:--:--.-', 2, 999, 1, 'M', 1),
(231, 'Венелина Емилова', 44, '-:--:--.-', 4, 999, 1, 'M', 0),
(232, 'Тео Дучев', 215, '-:--:--.-', 2, 999, 1, 'M', 1),
(233, 'Даниела Кадева', 216, '-:--:--.-', 3, 999, 1, 'M', 0);
...
(1, 'ТОДОРКА VERTICAL', '2025-08-08 19:20:12.000000', 23, 3);
