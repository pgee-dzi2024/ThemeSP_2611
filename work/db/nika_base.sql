...
--
-- Хост: 127.0.0.1
-- Време на генериране:  8 авг 2025 в 21:19
...
(24, 'Кристиян Кобер', 2, '-:--:--.-', 5, 999, 1, 'M', 1),
...
(42, 'Анелия Партенова', 33, '-:--:--.-', 3, 999, 1, 'M', 0),
...
(136, 'Димитър Стоянов', 78, '-:--:--.-', 4, 999, 1, 'M', 1),
...
(155, 'Александър Димитров', 26, '-:--:--.-', 3, 999, 1, 'M', 1),
(156, 'Лора Божилова', 115, '-:--:--.-', 3, 999, 1, 'M', 0),
(157, 'Камелия Божилова', 105, '-:--:--.-', 4, 999, 1, 'M', 0),
(158, 'Димитър Мавродиев', 76, '-:--:--.-', 5, 999, 1, 'M', 1),
(159, 'Мехмед Мехмед', 126, '-:--:--.-', 4, 999, 1, 'M', 1),
(160, 'Елена Татарска', 84, '-:--:--.-', 5, 999, 1, 'M', 0),
(161, 'Андрий Дерунов', 176, '-:--:--.-', 5, 999, 1, 'M', 1),
(162, 'Красимир Гергов', 109, '-:--:--.-', 4, 999, 1, 'M', 1),
(163, 'Иван Пандинов', 97, '-:--:--.-', 5, 999, 1, 'M', 1),
(164, 'Мартин Инчев', 121, '-:--:--.-', 3, 999, 1, 'M', 1),
(165, 'Паул Чапман', 202, '-:--:--.-', 5, 999, 1, 'M', 1),
(166, 'Трейси Пийт', 212, '-:--:--.-', 5, 999, 1, 'M', 0),
(167, 'Теодора Тодорова', 168, '-:--:--.-', 3, 999, 1, 'M', 0),
(168, 'Мартин Тодоров', 125, '-:--:--.-', 2, 999, 1, 'M', 1),
(169, 'Стоян Мавродиев', 166, '-:--:--.-', 4, 999, 1, 'M', 1),
(170, 'Емилиян Френчев', 180, '-:--:--.-', 4, 999, 1, 'M', 1),
(171, 'Владимир Ангелов', 53, '-:--:--.-', 4, 999, 1, 'M', 1),
...
(176, 'Аглика Бяндова', 175, '-:--:--.-', 3, 999, 1, 'M', 0),
(177, 'Петър Тодоров', 149, '-:--:--.-', 4, 999, 1, 'M', 1),
(178, 'Георги Котирков', 60, '-:--:--.-', 4, 999, 1, 'M', 1),
(179, 'Величка Котиркова', 42, '-:--:--.-', 4, 999, 1, 'M', 0),
...
(1, 'ТОДОРКА VERTICAL', '2025-08-08 19:16:00.305791', 0, 0);
