...
--
-- Хост: 127.0.0.1
-- Време на генериране:  8 авг 2025 в 15:50
...
(1, 'pbkdf2_sha256$600000$WRVKovSTGb2ZvqzgZjCbCF$N69TaCQClH5kugaW0ontEbIyUdM+atS8t3TVvMwTZWg=', '2025-08-05 20:40:37.842851', 1, 'nika_admin', '', '', '', 1, 1, '2025-07-28 09:02:22.129213');
...
(1, 'Иван Георгиев', 101, '12:19:22.3', 3, 0, 3, 'A', 1),
(2, 'Петър Иванов', 99, 'DQ', 4, 999, 0, 'M', 1),
(3, 'Георги Георгиев', 21, 'DQ', 6, 275, 0, 'A', 1),
(5, 'Виктор Василев', 55, 'DQ', 3, 274, 0, 'A', 1),
(7, 'Тодор Тодоров', 1, 'DQ', 6, 273, 0, 'A', 1),
(8, 'Петър Петров', 2, 'NS', 3, 9999, -1, 'M', 1),
(9, 'Славчо Друмев', 5, 'DQ', 3, 272, 0, 'A', 1),
(10, 'Минчо Празников', 6, 'DQ', 6, 271, 0, 'A', 1),
(11, 'Питър Пан', 8, 'DQ', 3, 270, 0, 'A', 1),
(12, 'Васил Викторов', 32, 'NS', 3, 9999, -1, 'M', 1),
(13, 'Васил Василев', 35, '12:20:51.0', 4, 0, 3, 'A', 1),
(14, 'Светослав Карагеоргиев', 66, '-:--:--.-', 4, 278, 2, 'M', 1),
(15, 'Мария Иванова', 7, '-:--:--.-', 2, 279, 2, 'M', 0),
(16, 'Георги Георгиев', 9, '-:--:--.-', 5, 280, 2, 'M', 1),
(17, 'Петко Петров', 3, 'DQ', 5, 9990, 0, 'M', 1);
...
--
-- Схема на данните от таблица `main_athletephoto`
--

INSERT INTO `main_athletephoto` (`id`, `image`, `athlete_id`) VALUES
(217, 'athlete_photos/tmp1ic1f2x0.jpg', 3),
(218, 'athlete_photos/tmparf3jn57.jpg', 5),
(219, 'athlete_photos/tmp1bvukidj.jpg', 7),
(220, 'athlete_photos/tmp1gmw0jqb.jpg', 8),
(221, 'athlete_photos/tmp9mzjmb8a.jpg', 1),
(222, 'athlete_photos/tmpbr9v_rle.jpg', 13);
...
(1, 'ТОДОРКА VERTICAL', '2025-08-07 21:30:17.294000', 281, 2);
